...
unsigned	FrameBuffer :: createColorTexture ( GLenum format, GLenum internalFormat, GLenum clamp, int filter )
{
	GLuint	tex;
...
unsigned	FrameBuffer :: createCubemapTexture ( GLenum format, GLenum internalFormat, GLenum clamp, int filter )
{
...
{
	return false;//isExtensionSupported ( "EXT_framebuffer_object" );
}
